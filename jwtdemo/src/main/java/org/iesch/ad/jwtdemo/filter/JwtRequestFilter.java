    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtService.validateToken(jwt, userDetails)) {
                ...
                SecurityContextHolder.getContext().setAuthentication(authenticationToken); // sirve para la práctica
            }
        }

        // Indicarle que será uin filtro y pasarle petición y respuesta
